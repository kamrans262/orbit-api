...
final class RegenerateAdminDataExportController
{
    public function __invoke(Request $request, string $exportId, AdminDataExportService $service, PrivacyPresenter $presenter): JsonResponse
    {
        $admin = $request->user();
        ...
        try {
            $newExport = $service->regenerate($export, $admin, $session, $data['reason'], $request);
        ...
        return AdminApiResponse::success($request, $presenter->export($newExport), 201);
    }
}
