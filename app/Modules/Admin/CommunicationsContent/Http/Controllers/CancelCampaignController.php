...
final class CancelCampaignController
{
    public function __invoke(Request $request, string $campaignId, CampaignService $service, AdminAuditLogger $audit): JsonResponse
    {
        ...
        $audit->write('communications.campaign.cancelled', $request->user(), $request->attributes->get('admin_session'), 'communication_campaign', $c->id, request: $request);
