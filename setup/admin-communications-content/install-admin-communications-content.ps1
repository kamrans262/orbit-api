...
foreach ($path in @($apiRoutes, $consoleRoutes)) {
    ...
    $backup = "$path.pre-admin-communications-m7-backup"
...
Add-OrbitRequireLine -Path $apiRoutes -Line "require __DIR__.'/communications_content.php';"
Add-OrbitRequireLine -Path $apiRoutes -Line "require __DIR__.'/admin_communications_content.php';"
Add-OrbitRequireLine -Path $consoleRoutes -Line "require __DIR__.'/console_communications_content.php';"
...
Write-Host ''
Write-Host 'Orbit Admin Communications / Content / Regional Milestone 7 wiring installed.'
...
Write-Host '  php artisan test tests\Feature\Api\Admin\V1\AdminCommunicationsContentRegionalTest.php'
...
Write-Host '  php artisan route:list --path=admin/v1/communications'
Write-Host '  php artisan route:list --path=admin/v1/content'
Write-Host '  php artisan route:list --path=admin/v1/maintenance'
Write-Host '  php artisan route:list --path=v1/platform'
