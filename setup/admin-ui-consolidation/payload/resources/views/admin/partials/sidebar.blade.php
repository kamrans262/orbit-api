<aside class="orbit-sidebar" data-sidebar aria-label="Administrator navigation">
    ...
    <nav class="orbit-sidebar__nav">
        ...
        <div class="orbit-nav-group">
            ...
            <span class="orbit-nav-item orbit-nav-item--disabled" aria-disabled="true"><span class="orbit-nav-icon" aria-hidden="true">✚</span><span>Safety / SOS</span><small>Next UI milestone</small></span>
            <span class="orbit-nav-item orbit-nav-item--disabled" aria-disabled="true"><span class="orbit-nav-icon" aria-hidden="true">◇</span><span>Moderation & Reports</span><small>Next UI milestone</small></span>
            <span class="orbit-nav-item orbit-nav-item--disabled" aria-disabled="true"><span class="orbit-nav-icon" aria-hidden="true">?</span><span>Support</span><small>Next UI milestone</small></span>
        </div>
